    ...
    <div class="head_container desktop">
         <div class="head_left">
              <ul>
                   ...
                   <li><a href="index.php?page=Sale&start_date=0/0/0000&end_date=0/0/0000&rooms=1&qua-adults=1&min_adults=1&discount_code=0<?php if($change == 1) echo '&go=1'?>" class="title">Đặt phòng</a></li>
         ...
         <div class="head_right">
              <ul>
                   <li><a href="index.php?page=Sale&start_date=0/0/0000&end_date=0/0/0000&rooms=1&qua-adults=1&min_adults=1&discount_code=1<?php if($change == 1) echo '&go=1'?>" class="title">Ưu đãi khuyến mãi</a></li>
                   <?php 
