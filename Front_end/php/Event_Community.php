...
<!-- Nội dung của trang Community -->
     <?php
          ...
          include "../conn.php";
          $sql = "SELECT * FROM sukien WHERE IDSukien=3";
          $re = mysqli_query($conn, $sql);
          $r = mysqli_fetch_array($re);
     ?>
     <div class="Eventcontent">
          <p class="Community"><?php if(isset($r['Mota']) && $r['Mota']!="") { echo $r['Mota']; } ?></p>
     </div>
     <div class="request_btn">
          <a href="#" class="large_btn" data-content="Community">Gửi yêu cầu</a>
     </div>
</div>
<div  id="hiddenCommunityForm">
     <div class="RequestCard Community">
          ...
          <form action="" id="communityForm">
               ...
               <div class="Submit_btn">
                    <input type="submit" value="Gửi yêu cầu" name="CommunityRequest" class="large_btn">
               </div>
...
<div class="swiper" id="CommunitySlide" >
     <div class="swiper-wrapper">
          <?php
               $sql = "SELECT * FROM hinhsk WHERE IDSukien=3";
               $re = mysqli_query($conn, $sql);
